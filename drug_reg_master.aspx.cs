...
{
	/// <summary>
	/// Summary description for drug_reg_master.
	/// </summary>
	public partial class drug_reg_master : System.Web.UI.Page
	{
...
//NewRecord Button
		protected void but_new_Click(object sender, System.EventArgs e)
		{
			...
			cmd=new SqlCommand("select count(*) from drug_reg_master",cn);
			...
			{
				cn.Open();
                cmd = new SqlCommand("select max(drug_id)+1 from drug_reg_master", cn);
		...
		protected void but_save_Click(object sender, System.EventArgs e)
		{
			...
			r[4]=txt_chemical.Text.ToString();
			ds.Tables["drug"].Rows.Add(r);
...
//DataGrid1_CancelCommand
		...
		private void DataGrid1_UpdateCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			TextBox f=(TextBox)e.Item .Cells [4].Controls [0];
			DataRow r;
			int rownumber;
			rownumber=e.Item.ItemIndex;
			r=ds.Tables["drug"].Rows[rownumber];
			r[0]= a.Text;
			r[1]= b.Text;
			r[2]= c.Text;
			r[3]= d.Text;
