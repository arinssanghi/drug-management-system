...
{
	/// <summary>
	/// Summary description for anti_allergic_drugs.
	/// </summary>
	public partial class anti_allergic_drugs : System.Web.UI.Page
	{
...
//Filldata Method
		...
		{
			ds=new DataSet();
			da=new SqlDataAdapter("select * from anti_allergic_drug",cn);
			da.Fill(ds,"anti_allergic");
...
//NewRecord Button
		protected void but_new_Click(object sender, System.EventArgs e)
		{
			...
			cmd=new SqlCommand("select count(*) from anti_allergic_drug",cn);
			...
			{
				cn.Open();
				cmd=new SqlCommand("select max(anti_allerg_drug_id)+1 from anti_allergic_drug",cn);
				txt_drug_id.Text=Convert.ToInt32(cmd.ExecuteScalar()).ToString();
				cn.Close();
			}
			txt_short_name.Text="";
			txt_long_name.Text="";//file:///D:\drug\Employee_components.aspx.resx
			txt_general_descr.Text="";
...
//Save Button
		...
		{
			filldata();
			r=ds.Tables["anti_allergic"].NewRow();
			r[0]=Convert.ToInt32(txt_drug_id.Text);
			r[1]=txt_short_name.Text.ToString();
			r[2]=txt_long_name.Text.ToString();
			r[3]=txt_general_descr.Text.ToString();
		
			ds.Tables["anti_allergic"].Rows.Add(r);
			cb=new SqlCommandBuilder(da);
			da.Update(ds,"anti_allergic");
			filldata();
...
//DataGrid1_UpdateCommand
		private void DataGrid1_UpdateCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			r=ds.Tables["anti_allergic"].Rows[rownumber];
			r[0]= a.Text;
			r[1]= b.Text;
			r[2]= c.Text;
			r[3]= d.Text;
...
//DataGrid1_DeleteCommand
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			int a;
			a=e.Item.ItemIndex;
			ds.Tables["anti_allergic"].Rows[a].Delete();
			cb=new SqlCommandBuilder(da);
			da.Update(ds,"anti_allergic");
			filldata();
		}
