...
//Filldata Method
		...
		protected void but_new_Click(object sender, System.EventArgs e)
		{
			...
			cmd=new SqlCommand("select count(*) from designation_master",cn);
			...
			{
				cn.Open();
				cmd=new SqlCommand("select max(desig_id)+1 from designation_master",cn);
				txt_desig_id.Text=Convert.ToInt32(cmd.ExecuteScalar()).ToString();
				cn.Close();
			}
			txt_desig_name.Text="";
...
//Save Record Coding
		...
		{
			filldata();
			r=ds.Tables["desig_master"].NewRow();
			r[0]=Convert.ToInt32(txt_desig_id.Text);
			r[1]=txt_desig_name.Text.ToString();
			r[2]=txt_desig_descr.Text.ToString();
			ds.Tables["desig_master"].Rows.Add(r);
			cb=new SqlCommandBuilder(da);
			da.Update(ds,"desig_master");
			filldata();
...
//DataGrid Update Command Coding
		private void DataGrid1_UpdateCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			r=ds.Tables["desig_master"].Rows[rownumber];
			r[0]= a.Text;
			r[1]= b.Text;
			r[2]= c.Text;
...
//DataGrid1_DeleteCommand
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			int a;
			a=e.Item.ItemIndex;
			ds.Tables["desig_master"].Rows[a].Delete();
			cb=new SqlCommandBuilder(da);
			da.Update(ds,"desig_master");
			filldata();
		}
